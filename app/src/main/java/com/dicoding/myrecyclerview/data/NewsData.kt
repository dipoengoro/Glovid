...
object NewsData {
    ...
    private val newsContent = arrayOf(
        "Pada tahun 2021, MUI terbitkan fatwa terkait vaksinasi COVID-19 dan tes swab selama menjalankan ibadah puasa, yakni bahwa keduanya tidak membatalkan puasa.\n" +
                ...
                "\n" +
                "Sumber Berita: https://covid19.go.id/artikel/2022/03/31/vaksinasi-covid-19-dan-tes-swab-tidak-batalkan-puasa",




        "JAKARTA - Satuan Tugas (Satgas) Penanganan COVID-19 menerbitkan Surat Edaran (SE) No. 16 Tahun 2022 tentang Ketentuan Perjalanan Orang Dalam Negeri Pada Masa Pandemi Corona Virus Disease Tahun 2019. SE terkait Pelaku Perjalanan Dalam Negeri (PPDN) ini berlaku efektif mulai 2 April 2022.\n" +
                "\n" +
                ...
                "\n" +
                "Juru Bicara Pemerintah untuk Penanganan COVID-19 Prof. Wiku Adisasmito menjelaskan lebih lanjut, bahwa penyesuaian kebijakan dalam SE ini dengan penuh pertimbangan. Salah satunya, Kementerian Perhubungan memperkirakan aktivitas mudik akan meningkatkan tren mobilitas antar daerah. Survei Kemenhub memprediksi ada 79 juta orang yang akan melakukan mudik lebaran.\n" +
                "\n" +
                ...
                "\n" +
                "Sumber Berita: https://covid19.go.id/artikel/2022/04/03/vaksin-booster-untuk-mudik-aman-dan-bertanggung-jawab",
        ...
        "JAKARTA - Masyarakat yang ingin mudik tahun ini sebaiknya telah mempersiapkan diri. Salah satunya dengan melengkapi diri dengan vaksin booster sebagai perlindungan lebih saat melakukan perjalanan ke kampung halaman. Agar, para pemudik terlindungi dan tidak membawa pulang virus saat bertemu keluarga di hari raya Idul Fitri 1443 Hijriah.\n" +
                "\n" +
                ...
                "\n" +
                "Sumber Berita: https://covid19.go.id/artikel/2022/04/05/prof-wiku-segera-booster-agar-mudik-terlindungi-sampai-tujuan",
        ...
        "JAKARTA - Sejak Januari 2022 menjelang periode mudik lebaran, cakupan vaksinasi booster naik secara konsisten. Pada level nasional, capaian saat ini mencapai 9,52 persen target Kementerian Kesehatan, atau naik sekitar 15 kali lipat dalam 3 bulan.\n" +
                "\n" +
                ...
                "\n" +
                "Dengan demikian, Wiku menegaskan bahwa upaya ini dapat mencegah lonjakan kasus contohnya di perhelatan MotoGP Mandalika baru-baru ini. Namun tentunya upaya vaksinasi harus dibarengi juga dengan pengawasan protokol kesehatan ketat sehingga dapat mencegah penularan secara maksimal.\n" +
                "\n" +
                "Jakarta 5 April 2022\n" +
                "\n" +
                "Tim Komunikasi Komite Penanganan Corona Virus Disease 2019 (Covid-19) dan Pemulihan Ekonomi Nasional\n" +
                "\n" +
                "Sumber Berita: https://covid19.go.id/artikel/2022/04/05/cakupan-vaksinasi-booster-konsisten-meningkat-sejak-januari-2022",
        ...
        "Perkembangan tren kasus Covid-19 di Indonesia makin membaik setiap harinya sehingga berdampak terciptanya kenyamanan bagi masyarakat dalam menjalani ibadah puasa pada tahun 2022. Namun, masyarakat harus tetap waspada karena risiko infeksi masih tetap ada dan pandemi belum dinyatakan usai, juga belum dinyatakan sebagai endemi.\n" +
                "\n" +
                "Hal tersebut disampaikan oleh dr. Reisa Broto Asmoro selaku Juru Bicara Pemerintah dan Duta Adaptasi Kebiasaan Baru dalam keterangan persnya pada Rabu, 6 April 2022 di Kantor Presiden, Jakarta, yang ditayangkan langsung pada kanal YouTube Sekretariat Presiden.\n" +
                "\n" +
                ...
                "\n" +
                "Sumber Berita: https://covid19.go.id/artikel/2022/04/06/mudik-lebaran-2022-diizinkan-reisa-ingatkan-syarat-vaksinasi-untuk-perjalanan",
        ...
        "Jakarta - Bulan suci Ramadhan tahun ini sedikit berbeda dari dua tahun terakhir, meski masih berlangsung dalam suasana pandemi COVID-19. Tahun ini, masyarakat dapat beribadah tanpa pembatasan dan diperbolehkan untuk mudik. Namun, masyarakat diharapkan tetap waspada dan saling menjaga dengan tetap konsisten menerapkan protokol kesehatan. Karena, masih banyak kelompok rentan disekitar kita.\n" +
                "\n" +
                "Menurut Direktur Urusan Agama Islam dan Pembinaan Syariah Ditjen Bimas Islam Kementerian Agama Dr. H. Adib, M.Ag, “Bahwa mencegah mafsadatan (kerusakan) lebih didahulukan daripada mengambil kemaslahatan. Oleh karena itu, maka dalam konteks di bulan Ramadhan ini kita juga dianjurkan untuk tetap menjaga protokol kesehatan. Selain itu kita juga dianjurkan untuk mengikuti vaksinasi meskipun di bulan Ramadhan ini.”\n" +
                "\n" +
                "Dalam Islam, menjaga diri maupun orang lain itu adalah kewajiban. Oleh karena itu protokol kesehatan pada saat pelaksanaan ibadah itu harus tetap dilaksanakan sebaik-baiknya. Bagaimana kita menggunakan masker dengan baik, mencuci tangan, dan menjaga jarak, jangan sampai diabaikan. Jika abai terhadap protokol kesehatan, maka bisa membahayakan diri sendiri dan orang lain.\n" +
                "\n" +
                "Adib juga menegaskan, selama bulan Ramadhan jika dianjurkan untuk melakukan vaksinasi COVID-19, maka boleh dilakukan. Vaksinasi menggunakan metode injeksi adalah halal dan membatalkan puasa. Hal ini sesuai dengan fatwa MUI Nomor 13 Tahun 2021. Karena itu, masyarakat yang akan melaksanakan mudik, dianjurkan untuk melakukan vaksinasi lanjutan atau booster.\n" +
                "\n" +
                ...
                "\n" +
                "Penanggulangan Covid-19 merupakan tanggung jawab seluruh elemen bangsa. Terdapat dua elemen penanggulangan Covid-19 di indonesia. Pertama, tanggung jawab yang bersifat kebangsaan dan kenegaraan ini tanggung jawab yang harus dipikul oleh pemerintah dan juga warga negara. Jadi, sebagai warga negara juga memiliki tanggung jawab yang sama. Kedua, adalah tanggung jawab keagamaan. Agama memerintahkan kepada umat untuk senantiasa menjaga kesehatan, menghindari sesuatu yang bersifat mafsadah (kerusakan).\n" +
                "\n" +
    ...
    private val newsThumb = intArrayOf(
        R.drawable.news_2,
        R.drawable.news_3,
        R.drawable.news_4,
        R.drawable.news_5,
    ...
    val listData: ArrayList<News>
        get() {
            ...
            for (position in newsTitle.indices) {
                ...
                news.thumbnail = newsThumb[position]
                list.add(news)
            }
            return list
        }
